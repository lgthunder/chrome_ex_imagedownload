(function () {
  ...
  imageDownloader.title=document.title
  ...
  chrome.extension.sendMessage({ linkedImages: imageDownloader.linkedImages, images: imageDownloader.images ,page_title:document.title});

  imageDownloader.linkedImages = null;
  imageDownloader.images = null;
  imageDownloader.title=null;
}());
